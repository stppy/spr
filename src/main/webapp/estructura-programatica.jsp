    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content" id="programacion">
          <!-- Info row de buscador de estrucutra programatica -->
         
		
       <div class="row">
				<%@ include file="/frames/estructura-programatica-buscador.jsp" %>
        </div><!-- /.row -->
 		<div class="row" id="crear-estructura-programatica" style="display:none">
        	<%@ include file="/frames/estructura_programatica_formulario.jsp" %>
       </div>
 		<div class="row" id="buscar-estructura-programatica">
            <div class="col-md-12">
              <div class="box collapsed-box" height="1000px">
                <div class="box-header with-border" height="1000px">
                  <h3 class="box-title" id="tituloTipoPrograma">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>Productos Asignados
                  </h3>
                ...
                <div class="box-body" >
                	<div class="row" id="row-body-programacionfisica"></div>
						...
						<script src="/frames/estructura-programatica.js"></script>
