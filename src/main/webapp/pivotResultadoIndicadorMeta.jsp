      ...
      <div class="content-wrapper">
		...
		$( document ).ready(function() {
            ...
            $(function(){
               ...
               // $.getJSON("http://spr.stp.gov.py/ajaxSelects?accion=getResultadoIndicadorMeta&entidad="+usuarios[0].entidad_id+"&nivel="+usuarios[0].nivel_id, function(mps) {
            	    $.getJSON("http://spr.stp.gov.py/ajaxSelects?accion=getResultadoIndicadorMeta", function(mps) {
                	alert(mps.length);
                	$("#output").pivotUI(mps, {
                       // renderers: $.extend(
