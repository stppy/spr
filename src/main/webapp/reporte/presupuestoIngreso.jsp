	...
	$(document).ready(function(){
		...
		caja=	"<div class='table-responsive'>"+
			...
			var presupuestoIngreso = $.ajax({
				url:'/ajaxSelects?accion=getPresupuestoIngresoPresi&nivel='+usuarios[0].nivel_id+'&entidad='+usuarios[0].entidad_id,
			  	type:'get',
			  	dataType:'json',
			  	async:false       
			}).responseText;
			...
			{
				caja+="<tr><td>"+presupuestoIngreso[s].codOrigen+"</td><td>"+presupuestoIngreso[s].codDetalle+"</td><td>"+presupuestoIngreso[s].fuenteFinanc+"</td><td>"+presupuestoIngreso[s].montoProgramado+"</td></tr>";
			}
